    ...
    <body>
        ...
        <table class="table-admin">
            ...
            <tr>
                ...
                <td><a href="admin.php?delete=1&mahd=<?php echo $hd->MaHD; ?>" onclick="return confirm('Xóa hóa đơn này?')">Xóa</a></td>
            </tr>
            <?php endforeach; ?>
        </table>
        ...
        <form method="post" class="admin-form">
            ...
            <input type="datetime-local" name="ngaylap" value="<?php echo date('Y-m-d\TH:i', strtotime($_POST['ngaylap'])); ?>" required>
